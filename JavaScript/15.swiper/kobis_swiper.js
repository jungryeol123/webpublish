    ...
    let output = `
        ...
        <div class="swiper-wrapper">
            ...
            ${posterList.map((posterUrl) => `
                ...
                <img class="swiper-img" src="${posterUrl}" alt=""> 
                </div>
            `).join()}
            <div class="swiper-slide"><img class="swiper-img" src="images/image1.jpg.jpg" alt=""></div>
            <div class="swiper-slide"><img class="swiper-img" src="images/image2.jpg.jpg" alt=""></div>
            <div class="swiper-slide"><img class="swiper-img" src="images/image3.jpg.jpg" alt=""></div>
        </div>
